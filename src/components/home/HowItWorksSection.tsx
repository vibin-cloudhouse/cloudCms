      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6">
          <div className="glass-card p-8 relative dark:bg-slate-800/50 dark:border-slate-700">
            <div className="w-12 h-12 bg-gradient-to-r from-[#006FEE] to-cyan-600 text-white rounded-full flex items-center justify-center font-bold text-xl mb-6">1</div>
            ...
            <div className="absolute top-1/2 right-0 transform translate-x-1/2 -translate-y-1/2 hidden md:block">
              <ArrowRight className="w-8 h-8 text-teal-300 dark:text-[#006FEE]" />
            </div>
            <div className="absolute -bottom-1 left-10 right-10 h-4 bg-white blur-xl opacity-80 dark:bg-slate-800 dark:opacity-50"></div>
          </div>
          
          <div className="glass-card p-8 relative dark:bg-slate-800/50 dark:border-slate-700">
            <div className="w-12 h-12 bg-gradient-to-r from-[#006FEE] to-cyan-600 text-white rounded-full flex items-center justify-center font-bold text-xl mb-6">2</div>
          ...
          <div className="glass-card p-8 relative dark:bg-slate-800/50 dark:border-slate-700">
            <div className="w-12 h-12 bg-gradient-to-r from-[#006FEE] to-cyan-600 text-white rounded-full flex items-center justify-center font-bold text-xl mb-6">3</div>
